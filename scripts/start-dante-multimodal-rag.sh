...
echo "Dante KB backend:          ${DANTEDASH_KB_BACKEND} (chroma fallback: ${DANTEDASH_CHROMA_FALLBACK_ENABLED}, strict no-Chroma: ${DANTEDASH_STRICT_NO_CHROMA}, visual rescue: ${DANTEDASH_CHROMA_VISUAL_RESCUE_ENABLED})"
